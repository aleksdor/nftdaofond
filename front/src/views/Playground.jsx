...
const PlaygroundHeaderRow = styled.div`
...
`
const PlaygroundGenerateBtn = styled(Button)`
	width: 100%;
    height: 4rem;
    font-weight: 700;
...
`
const PlaygroundTraitForm = styled.form`
	height: 4rem;
`
const PlaygroundFloatingLabel = styled.div`
	font-size: 15px;
	color: #8c8d92;
`
const PlaygroundTraitFormBtn = styled.select`
...
`
const PlaygroundNounYearsFooter = styled.p`
	font-style: italic;
	padding-top: 1rem;
`
		...
		<>
			...
			<div className="content-wrapper">
				<div className="container-lg">
					<div className="row">
						<PlaygroundHeaderRow className="col-lg-10">
							<span>Explore</span>
							<h1>Playground</h1>
						</PlaygroundHeaderRow>
					</div>
					<div className="row">
						<div className="col-lg-3">
							<PlaygroundGenerateBtn type="button" onClick={() => merge()}>Generate Floros</PlaygroundGenerateBtn>
							{
								imagesData.map(({ folderName, data }) => (
									<PlaygroundTraitForm>
										<PlaygroundFloatingLabel className="form-floating">
											<PlaygroundTraitFormBtn
